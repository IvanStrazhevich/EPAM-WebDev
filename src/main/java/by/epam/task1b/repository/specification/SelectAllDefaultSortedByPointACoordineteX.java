...
public class SelectAllDefaultSortedByPointACoordineteX<R> implements QuerySpecification<ArrayList<Figure>> {
    static Logger logger = LogManager.getLogger();
    private Comparator<Figure> comparator;

    public SelectAllDefaultSortedByPointACoordineteX(Comparator<Figure> comparator) {
        this.comparator = comparator;
    }

    public SelectAllDefaultSortedByPointACoordineteX() {
    }
    ...
    public ArrayList<Figure> executeQuery() {
        ...
        if (comparator == null) {
            comparator = new CompareByPointACoordinateX();
        }
